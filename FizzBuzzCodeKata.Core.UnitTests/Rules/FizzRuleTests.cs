...
public class FizzRuleTests
{
    ...
    [Fact]
    public void GIVEN_FizzRule_WHEN_Execute_AND_ValidationFails_THEN_ShouldReturnError()
    {
        // Arrange
        ...
        var sut = new FizzRule(validationServiceMock.Object);
    ...
    public void GIVEN_FizzRule_WHEN_Execute_AND_ApplicableMod5NumbersInRange_THEN_ExpectedResultReturned(int inputValue)
    {
        // Arrange
        var model = new FizzbuzzModel
        {
    ...
    public void GIVEN_FizzRule_WHEN_Execute_AND_NonApplicableMod5NumbersInRange_THEN_ExpectedResultReturned(int inputValue)
    {
        // Arrange
        var model = new FizzbuzzModel
        {
    ...
    public void GIVEN_FizzRule_WHEN_RuleShouldRun_AND_Both_Mod3_AND_Mod5_Not_Applicable_THEN_Expected_True_Result_Returned(int inputValue)
    {
        // Arrange
        Mock<IValidationService> validationServiceMock = new();
    ...
    public void GIVEN_FizzRule_WHEN_RuleShouldRun_AND_Both_Mod3_AND_Mod5_Not_Applicable_THEN_Expected_False_Result_Returned(int inputValue)
    {
        // Arrange
        Mock<IValidationService> validationServiceMock = new();
